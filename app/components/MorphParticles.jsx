...
for (let x = 0; x < p.width; x++) {
  ...
  if (inter < 0.5) {
    ...
    h = p.lerp(330, 345, inter * 2);
  } else {
  
    h = p.lerp(345, 360, (inter - 0.5) * 2);
  }

  let s = p.lerp(85, 95, inter);
  let b = p.lerp(65, 85, inter);

  p.stroke(h % 360, s, b, 0.15);
